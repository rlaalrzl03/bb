		...
		<div id="body" class="home">
			<div class="header">
				...
				<div class ="m1">
					<div class="m">
						<h1>자료실 답글쓰기</h1>
						<form action="JaroreWritePro.jsp" method="post" name="fr" enctype="multipart/form-data">
						...
						<tr>
						<td>파일</td>
						<td><input type="file" name="file" value="파일업로드"></td>
						</tr>
						...
						<input type ="button" value="목록보기" class="btn" onclick="location.href='Jaro.jsp'">
						</div>
