...
int DBReadcount = jaroBean.getReadcount();
String DBName = jaroBean.getName();
Timestamp DBDate = jaroBean.getDate();
...
int DBRe_ref = jaroBean.getRe_ref();
int DBRe_lev = jaroBean.getRe_lev();
int DBRe_seq = jaroBean.getRe_seq();
...
<body>
			...
			<div class="header">
				...
				<div class ="m1">
					<div class="m">
						...
						<tr>  
						<td>파일</td>	
						<td colspan="3" onclick="location.href='download.jsp?filename=<%=DBFile%>'"><%=DBFile %></td>
						</tr>
	...
	if(id!=null){
	   ...
	   <input type="button" value="글수정" class="btn" 
			onclick="location.href='jaroUpdate.jsp?num=<%=DBnum%>&pageNum=<%=pageNum%>'">
			
			<input type="button" value="글삭제" class="btn"
			onclick="location.href='JaroDelete.jsp?num=<%=DBnum%>&pageNum=<%=pageNum%>'">
			
			<input type="button" value="답글쓰기" class="btn"
			onclick="location.href='JaroreWrite.jsp?num=<%=DBnum%>&re_ref=<%=DBRe_ref%>&re_lev=<%=DBRe_lev%>&re_seq=<%=DBRe_seq%>'">
		<%			
			}
		%>
