...
jBean.setRe_lev(Integer.parseInt(multi.getParameter("re_lev")));   
jBean.setRe_seq(Integer.parseInt(multi.getParameter("re_seq")));       
jBean.setRe_ref(Integer.parseInt(multi.getParameter("re_ref")));   
