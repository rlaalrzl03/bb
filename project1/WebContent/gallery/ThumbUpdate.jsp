			...
			<div class="header">
				...
				<div class = "m1">
					<div class="m">
						...
						<h1>갤러리 수정</h1>
						<form action="ThumbUpdatePro.jsp?pageNum=<%=pageNum%>" method="post" name="fr" enctype="multipart/form-data" >
						...
						<tr>
						<td>이미지</td>
						<td><img src="../image/<%=DBFile%>" id="imgs"><input type="file" name="file">
							...
							onclick="location.href='ThumbDelete.jsp?num=<%=DBnum%>&pageNum=<%=pageNum%>'">
							
						<input type="button" value="글목록" class="btn" onclick="location.href='Thumbnail.jsp'">
						</form>
