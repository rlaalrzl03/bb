...
thumbBean thumbbean = tdao.getThumb(num); 
 
int DBnum = thumbbean.getNum();
int DBReadcount = thumbbean.getReadcount();
String DBName = thumbbean.getName();
Timestamp DBDate = thumbbean.getDate();
String DBSubject = thumbbean.getSubject();
String DBFile = thumbbean.getFile();
String DBContent = "";
if(thumbbean.getContent() != null){
    DBContent = thumbbean.getContent().replace("\r\n", "<br>/");
    
}
int DBRe_ref = thumbbean.getRe_ref();
int DBRe_lev = thumbbean.getRe_lev();
int DBRe_seq = thumbbean.getRe_seq();
...
<body>
			...
			<div class="header">
				...
				<div class="m1">
					<div class="m">
						...
						<tr>  
						<td>이미지</td>	
						<td colspan="3" id="imgtd"><img src="../image/<%=DBFile%>" id="imgs"></td>
						</tr>
	...
	if(id!=null){
	   ...
	   <input type="button" value="글수정" class="btn" 
			onclick="location.href='ThumbUpdate.jsp?num=<%=DBnum%>&pageNum=<%=pageNum%>'">
			
			<input type="button" value="글삭제" class="btn"
			onclick="location.href='ThumbnailDelete.jsp?num=<%=DBnum%>&pageNum=<%=pageNum%>'">
